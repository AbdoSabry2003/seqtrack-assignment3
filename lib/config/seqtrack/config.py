...
cfg.TRAIN.PRINT_INTERVAL_SAMPLES = 50  # 🔥 NEW: interval to log progress every N samples
cfg.TRAIN.VAL_EVERY = 1  # 🔥 NEW: run validation every N epochs
cfg.TRAIN.GRAD_CLIP_NORM = 0.1
cfg.TRAIN.AMP = False  # NEW: Automatic Mixed Precision
# TRAIN.SCHEDULER
cfg.TRAIN.SCHEDULER = edict()
cfg.TRAIN.SCHEDULER.TYPE = "step"
cfg.TRAIN.SCHEDULER.DECAY_RATE = 0.1

cfg.TRAIN.SEED = None  # NEW: للـ reproducibility
cfg.TRAIN.HF_TOKEN = None  # NEW: اختياري - Hugging Face token
cfg.TRAIN.HF_REPO = None  # NEW: اختياري - Hugging Face repo
cfg.TRAIN.RESUME_PATH = None  # NEW: للاستئناف من checkpoint
...
cfg.DATA.TRAIN.SELECTED_CLASSES = None
# DATA.SEARCH
