...
def ltr_collate_stack1(batch):
    ...
    if isinstance(batch[0], torch.Tensor):
        # [A3-FIX] Direct stack without out parameter to avoid resize warnings
...
class LTRLoader(torch.utils.data.dataloader.DataLoader):
    ...
    def __init__(self, name, dataset, training=True, batch_size=1, shuffle=False, sampler=None, batch_sampler=None,
                 ...
                 timeout=0, worker_init_fn=None, generator=None, persistent_workers=False, prefetch_factor=2):
        """
        🔥 MODIFIED: Added generator parameter for reproducible data loading
        """
        ...
        # 🔥 NEW: Pass generator to parent DataLoader for reproducibility
        # Build kwargs dict to handle version compatibility
        loader_kwargs = {
            'dataset': dataset,
        ...
        # Add prefetch_factor if specified
        ...
        self.generator = generator  # [A3-SEED] keep handle for epoch reseeding